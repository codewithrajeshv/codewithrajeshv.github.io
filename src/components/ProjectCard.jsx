...
const ProjectCard = ({ project, index }) => {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -5 }}
      className="bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-700 flex h-28 sm:h-32"
    >
      {/* Project Icon */}
      <motion.div
        whileHover={{ scale: 1.05 }}
        transition={{ duration: 0.2 }}
        className="relative w-28 sm:w-32 flex-shrink-0"
      >
        <img
          src={image}
          alt={name}
