...
const Header = () => {
  const socialLinks = [
    {
      name: "Twitter",
      url: "https://twitter.com/codewithrajv",
      icon: (
    ...
    {
      name: "GitHub",
      url: "https://github.com/codewithrajeshv",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/rajeshverma17",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <header className="w-full bg-gray-900 py-8 sm:py-16 px-4">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center gap-8"
      >
        {/* Profile Image */}
        <motion.div
          initial={{ scale: 0 }}
        ...
        <div className="flex-1 text-center sm:text-left">
          <motion.h1
            ...
            className="text-3xl sm:text-4xl font-bold text-gray-100 mb-2"
          >
            Rajesh Verma
          </motion.h1>
          <motion.h2
